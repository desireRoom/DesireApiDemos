...
public class BouncingBalls extends Activity {
    ...
    public class MyAnimationView extends View {
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            ValueAnimator squash2 = ObjectAnimator.ofFloat(newBall, "width", newBall.getWidth(),
            ...
            ValueAnimator squash4 = ObjectAnimator.ofFloat(newBall, "height", newBall.getHeight(),
